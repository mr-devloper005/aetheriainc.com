...
export const editableRootStyle = {
  // Editorial SaaS system: soft paper surfaces, deep blue accent, hairline
  // borders and generous premium spacing.
  '--slot4-page-bg': '#fbfbf7',
  '--slot4-page-text': '#071635',
  '--slot4-panel-bg': '#eef4f3',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#5c6575',
  '--slot4-soft-muted-text': '#8b93a1',
  '--slot4-accent': '#2146d0',
  '--slot4-accent-fill': '#2146d0',
  '--slot4-accent-soft': '#e4ebff',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#061735',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#eeeeee',
  '--slot4-cream': '#fbfbf7',
  '--slot4-warm': '#f0f4f2',
  '--slot4-lavender': '#eef1ff',
  '--slot4-gray': '#eef4f3',
  '--slot4-body-gradient': 'radial-gradient(circle at 90% 0%, rgba(113,213,200,.12), transparent 28%)',
  '--editable-page-bg': '#fbfbf7',
  '--editable-page-text': '#071635',
  '--editable-container': '1440px',
  '--editable-border': '#d9dfdf',
  '--editable-nav-bg': '#fbfbf7',
  '--editable-nav-text': '#071635',
  '--editable-nav-active': '#2146d0',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#071635',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#061735',
