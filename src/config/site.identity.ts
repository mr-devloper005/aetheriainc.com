export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'aetheriainc',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Aetheriainc',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'aetheriainc.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://aetheriainc.com',
